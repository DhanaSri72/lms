    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md h-20'>
            <img src={assets.patients_icon} alt="patiets-icon" />
            <div>
          ...
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md h-20 '>
            ...
            <div>
              {/* <p className='text-2xl font-medium text-gray-600'>{dummyDashboardData.totalCourses.length}</p> */}
          ...
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md h-20 '>
            ...
            <div>
              {/* <p className='text-2xl font-medium text-gray-600'>{currency}{dummyDashboardData.totalEarnings.length}</p> */}
