    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500' >
        <div className='flex flex-col gap-1'>
          <p>Course Title</p>
          <input onChange={e =>setCourseTitle(e.target.value)} value={courseTitle} type="text" placeholder='Type here ...' className='outline-none border border-gray-500 md:py-2.5 py-2 px-3 rounded-md w-full' required />
        </div>
        <div className='flex flex-col gap-1'>
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg md-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  <img onClick={()=>handleChapter('toggle',chapter.chapterId)} className={`mr-2 cursor-pointer transition-all ${chapter.collapsed && '-rotate-90'}`} src={assets.dropdown_icon} alt="drop-down icon" width={14} />
              ...
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                ...
                <div className='mb-2'>
                 ...
                 {/* <div className='mb-2'>
                  ...
                  value={lectureDetails.isPreviewFree} onChange={(e) =>setLectureDetails({...lectureDetails, isPreviewFree: e.target.checked})}/>
                </div> */}

                <div className='mb-4'>
                  <label className='flex items-center gap-2'>
                    <input type="checkbox" checked={lectureDetails.isPreviewFree}
                    onChange={(e)=>setLectureDetails({...lectureDetails,isPreviewFree: e.target.checked})} className='form-checkbox h-4 w-4 text-blue-600'/>
                ...
                <img className='absolute top-4 right-4 w-4 cursor-pointer' src={assets.cross_icon} onClick={()=>setShowPopup(false)} alt="" />
